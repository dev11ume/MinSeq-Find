% PROGRAM TO SCORE SEQUENCES USING MINSEQS - v1
function int_chip_seq=...
    chip_seq_count_v1(max_gap,min_half_nmer,max_half_nmer,seqsx_inx_c,l,...
...
for jj=1:tot_chips
    ...
    if max_half_nmer==-1
        int_chip_seq{jj}=get_seq_scores_ng_v1(seq_colp5n_chipx,l,...
            min_nmer,max_nmer,int_nu2x_cs);
    else
        int_chip_seq{jj}=get_seq_scores_gp_v1(seq_colp5n_chipx,l,...
